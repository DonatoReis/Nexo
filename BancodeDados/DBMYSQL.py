...
# Conectar-se ao servidor MySQL sem especificar um banco de dados
conn = mysql.connector.connect(
 host='localhost', # Endereço do servidor MySQL
 user='root', # Nome de usuário do MySQL
 password='140220' # Senha do usuário do MySQL
)

cursor = conn.cursor()

# Criar o banco de dados se ele não existir
cursor.execute('CREATE DATABASE IF NOT EXISTS meu_banco_de_dados_mysql')
...
conn = mysql.connector.connect(
 ...
 user='root', # Nome de usuário do MySQL
 password='140220', # Senha do usuário do MySQL
 database='meu_banco_de_dados_mysql' # Nome do banco de dados MySQL
)
